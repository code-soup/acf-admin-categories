...
use CodeSoup\ACFAdminCategories\Core\Lifecycle;
...
final class Init {
	 ...
	 * @since 1.0.0
	 * @access protected
	 * @var array<\CodeSoup\ACFAdminCategories\Interfaces\ServiceProviderInterface>
	 */
	...
	public function init(): void {
		try {
			...
			// After all providers are booted, run the hooker to register all hooks
			$hooker = $this->get( 'hooker' );
			if ( $hooker instanceof \CodeSoup\ACFAdminCategories\Core\Hooker ) {
				$hooker->run();
			}
	...
	private function register_providers(): void {
		...
		$this->providers[] = new \CodeSoup\ACFAdminCategories\Providers\CoreServiceProvider();

		// Context-specific providers
		if ( is_admin() ) {
			$this->providers[] = new \CodeSoup\ACFAdminCategories\Providers\AdminServiceProvider();
		} else {
			$this->providers[] = new \CodeSoup\ACFAdminCategories\Providers\FrontendServiceProvider();
		}
	 ...
	 *
	 * @since 1.0.0
	 * @return \CodeSoup\ACFAdminCategories\Core\Hooker The hooker instance
	 * @deprecated Use get('hooker') instead
	 */
	public function get_hooker(): \CodeSoup\ACFAdminCategories\Core\Hooker {
	 ...
	 *
	 * @since 1.0.0
	 * @return \CodeSoup\ACFAdminCategories\Core\Assets The assets instance
	 * @deprecated Use get('assets') instead
	 */
	public function get_assets(): \CodeSoup\ACFAdminCategories\Core\Assets {
