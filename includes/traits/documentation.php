...
trait DocumentationTrait {
	...
	private function get_service_documentation(): array {
		return array(
			'container' => array(
				'class'       => 'CodeSoup\ACFAdminCategories\\Container',
			...
			'hooker'    => array(
				'class'       => 'CodeSoup\ACFAdminCategories\\Hooker',
			...
			'assets'    => array(
				'class'       => 'CodeSoup\ACFAdminCategories\\Assets',
			...
			'lifecycle' => array(
				'class'       => 'CodeSoup\ACFAdminCategories\\Lifecycle',
