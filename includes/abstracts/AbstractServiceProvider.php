...
namespace CodeSoup\ACFAdminCategories\Abstracts;

use CodeSoup\ACFAdminCategories\Interfaces\ServiceProviderInterface;
...
abstract class AbstractServiceProvider implements ServiceProviderInterface {
	 ...
	 * @return void
	 */
	protected function singleton( \CodeSoup\ACFAdminCategories\Core\Container $container, string $id, $concrete ): void {
	 ...
	 * @return void
	 */
	protected function factory( \CodeSoup\ACFAdminCategories\Core\Container $container, string $id, $concrete ): void {
	 ...
	 * @return void
	 */
	protected function alias( \CodeSoup\ACFAdminCategories\Core\Container $container, string $alias, string $id ): void {
